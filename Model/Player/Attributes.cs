...
namespace Game2
{
    public class Attributes
    {
        ...
        public static Attributes operator +(Attributes attribute, int number)
        {
            return new Attributes
            {
                Power = attribute.Power + number,
                Dexterity = attribute.Dexterity + number,
                Health = attribute.Health + number,
                Agression = attribute.Agression + number,
                Luck = attribute.Luck + number,
                Wisdom = attribute.Wisdom + number
            };
        }
